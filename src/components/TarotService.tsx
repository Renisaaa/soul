      ...
      <header className="fixed top-0 left-0 right-0 bg-white/80 backdrop-blur-md z-50 shadow-sm">
        <div className="container mx-auto flex justify-between items-center py-4">
          ...
          <nav className="hidden md:flex space-x-8">
            <button onClick={() => scrollToSection('home')} className="text-indigo-800 hover:text-indigo-600 font-medium cursor-pointer whitespace-nowrap">Home</button>
            <button onClick={() => scrollToSection('services')} className="text-indigo-800 hover:text-indigo-600 font-medium cursor-pointer whitespace-nowrap">Services</button>
            <button onClick={() => scrollToSection('about')} className="text-indigo-800 hover:text-indigo-600 font-medium cursor-pointer whitespace-nowrap">About</button>
            <button onClick={() => scrollToSection('testimonials')} className="text-indigo-800 hover:text-indigo-600 font-medium cursor-pointer whitespace-nowrap">Testimonials</button>
            <button onClick={() => scrollToSection('contact')} className="text-indigo-800 hover:text-indigo-600 font-medium cursor-pointer whitespace-nowrap">Contact</button>
          </nav>
